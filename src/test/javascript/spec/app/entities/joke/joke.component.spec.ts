  ...
  describe('Joke Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(JokeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.jokes && comp.jokes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
