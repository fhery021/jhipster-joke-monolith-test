...
import com.fhery021.joke.monolith.repository.CommentRepository;
...
public class CommentResourceIT {
    ...
    public void updateComment() throws Exception {
        ...
        restCommentMockMvc
            .perform(
                put("/api/comments").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedComment))
            )
            .andExpect(status().isOk());
    ...
    public void updateNonExistingComment() throws Exception {
        ...
        restCommentMockMvc
            .perform(put("/api/comments").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(comment)))
            .andExpect(status().isBadRequest());
